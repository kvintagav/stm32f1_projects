...
///Таблицы для вычисления CRC16-IBM (хранятся в ПЗУ МК)
...
/**
	*  @brief  Вычисление СRC16-IBM
	*  @param  puchMsg:		Указатель на массив входных данных
	*  @param  usDataLen:  	Длина входного массива данных в байтах
  *  @retval CRC16
	*/

uint16_t crc_calculating(uint8_t * puchMsg, unsigned short usDataLen)   /*##Расчёт контрольной суммы##*/
{
