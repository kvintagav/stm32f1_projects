...
#define SIZE_TEST_MSG 10

//Макросы для быстрого обмена
#define RADIO_DOWN_CE  	nRF24_GPIO->BRR = nRF24_CE
#define RADIO_UP_CE			nRF24_GPIO->BSRR = nRF24_CE
#define RADIO_DOWN_CSN 	nRF24_GPIO->BRR = nRF24_CSN
#define RADIO_UP_CSN		nRF24_GPIO->BSRR = nRF24_CSN
